...
(function () {
  ...
  var MESSAGES = {
    containerFound: "Znaleziono formularz ".concat(SELECTORS.container),
    error: {
      basic: "Error",
      containerNotFound: "Nie znaleziono kontenera ".concat(SELECTORS.container, ". Skrypt zosta\u0142 wstrzymany.")
    }
  };
  var container;
  var handleContainerNotFound = function handleContainerNotFound() {
    window.console.error("%c ".concat(MESSAGES.error.containerNotFound), "background: red; color: #fff; font-size: 20px");
  };
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 2:
            DOMElements = _context.sent;
            return _context.abrupt("return", DOMElements);
          case 4:
          case "end":
  ...
  var renderUiElements = function renderUiElements() {
    ...
    var newLink = currentLink.replace("orbico", "orbico-platform");
    link.href = newLink;
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 5:
            ...
            return _context2.abrupt("return", handleContainerNotFound());
          case 8:
            containerLink = container.querySelector("a");
            if (!containerLink) {
              _context2.next = 11;
              break;
            }
